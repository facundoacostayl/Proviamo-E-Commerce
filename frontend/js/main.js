...
const activateClientesDatePicker = () => {
  if (document.getElementById('cumpleanos')) {
    flatpickr("#cumpleanos", {
...
document.addEventListener('DOMContentLoaded', activateClientesDatePicker());
