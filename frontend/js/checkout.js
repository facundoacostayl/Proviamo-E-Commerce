...
function checked2() {
  ...
  if (!formContainer.firstElementChild) {
    let checkedForm = `
            <div class="col-12">
            <label for="shipping-date" class="order-form-label">Fecha de Envío<span class="form__check"> *</span></label>
            </div>
            ...
            <div class="col-12">
            <input id="calle" class="order-form-input" placeholder="Calle">
            </div>
            <div class="col-4 mt-2">
            <input id="numero" class="order-form-input" placeholder="Numero(Altura)">
            </div>
            <div class="col-4 mt-2">
            <input id="timbre" class="order-form-input" placeholder="Timbre">
            </div>
